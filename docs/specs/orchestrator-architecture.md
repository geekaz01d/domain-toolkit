  ...
  "tasks": {
    ...
    "tasks": [
      ...
      },
      {
        ...
        "type": "shell",
        "command": "claude --append-system-prompt-file .claude/agent.md 'Run /touch-full-domain and brief me'",
...
1. **Spawn**: `open-kit <domain> --cursor` opens the domain viewport, which launches Claude Code with `--append-system-prompt-file .claude/agent.md`
